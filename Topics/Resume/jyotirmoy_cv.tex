...
\begin{adcvtabletwo}
  ...
  \adcvrowmulti{Developed advanced computer vision techniques for congenial problems in the womb. Addressed clinical issues, namely, spina bifida and twin twin syndrome. Improving visualization using non-linear optimisation techniques. Published in reputed international conference.}
  ...
  \adcvrowmulti{Developed image guidance for catheter insertion in neonatal. Automated the process of identifying the fetal head for obstetric application. Contributed to key IP for the program and helped transition to product.}
