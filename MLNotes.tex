...
\begin{itemize}
\item Training: 
\[P(\theta \vert X_{\text{tr}}, y_{\text{tr}}) =  \frac{P(y_{\text{tr}} \vert X_{\text{tr}},\theta)P(\theta)}{P(y_{\text{tr}} \vert X_{\text{tr}})}\]
\item Prediction:
...
There are many great tutorials for variational inference, but I found the tutorial by Tzikas et al.\ \cite{4644060} to be the most helpful. It follows the steps of Bishop et al.\ \cite{Bishop:2006:PRM:1162264} and Neal et al.\ \cite{Neal:1999:VEA:308574.308679} and starts the introduction by formulating the inference as the Expectation Maximization. Here, we will summarize the steps in Tzikas et al.\ \cite{4644060} and elaborate some steps missing in the paper. Let $q(z)$
